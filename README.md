...
- Create a component called `AddAdoptionForm` that renders a form with fields dog name, dog age, dog breed, a radio button for potty trained (yes, no, somewhat), and a selection for dog color (white, brown, black, spotted, other)
